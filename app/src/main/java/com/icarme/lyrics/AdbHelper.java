...
final class AdbHelper {
    ...
    static String helpText() {
        return "首次安装需通过 ADB 授权（电脑连车机执行）：\n\n"
            ...
            + "4) 配置手机蓝牙 MAC（v2.0 车机主动连手机）\n"
            + "adb shell am broadcast -a com.icarme.lyrics.SET_PHONE "
            + "--es mac XX:XX:XX:XX:XX:XX -n com.icarme.lyrics/.AdbReceiver\n\n"
            + "5) 打开主界面\n"
